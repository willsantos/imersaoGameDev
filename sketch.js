...
function setup() {
  ...
  const inimigoGrande = new Inimigo(matrizInimigoGrande,ImagemTroll,width *4,0,200,200,400,400,3,1500 );
  const inimigoVoador = new Inimigo(matrizInimigoVoador,ImagemVoador,width -52,200,100,75,200,150,5,2000)
